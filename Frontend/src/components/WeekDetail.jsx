...
export default function WeekDetail() {
  ...
  const subjectPath = ["users", userId, "subjects", subjectId];
                ...
                <>
                    ...
                    {recentChats.length === 0 ? (
                      ...
                      recentChats.map((chat, i) => (
                        <div
                          ...
                          onClick={() =>
                            navigate(
                              `/Mentorchat/${subjectId}/${selectedWeek.id}?chat=${chat.id}`
                            )
                          }
                        >
                  ...
                  <button
                    ...
                    onClick={async () => {
                      ...
                      navigate(
                        `/Mentorchat/${subjectId}/${selectedWeek.id}?chat=${newChatId}`
                      );
                    }}
                  >
                    💬 채팅 시작!
                ...
                <>
                  ...
                  <div className="quiz-list-wrapper">
                      ...
                      <div className="quiz-list">
                        {quizList.map((quiz, idx) => (
                          <button
                            ...
                            onClick={() =>
                              navigate(
                                `/ReviewDetail/${subjectId}/${selectedWeek.id}/${quiz.id}`
                              )
                            }
                          >
                    ...
                    <button
                      ...
                      onClick={() =>
                        navigate(`/QuizAI/${subjectId}/${selectedWeek.id}`)
                      }
                    >
                      ＋ 문제 풀기
                    </button>
                      ...
                      <div className="wrong-note-list">
                        {wrongNotes.map((note) => (
                          <button
                            ...
                            onClick={() =>
                              navigate(
                                `/ReviewDetail/${subjectId}/${selectedWeek.id}/${note.id}`
                              )
                            }
                          >
                            {note.displayTitle}
